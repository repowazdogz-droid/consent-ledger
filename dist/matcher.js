...
exports.matchConsent = matchConsent;
...
function checkMonetaryLimit(constraint, parameters) {
...
function checkDomainRestriction(constraint, parameters) {
...
function checkTimeWindow(constraint, actionTimestamp) {
...
function checkApprovalRequired(constraint, parameters) {
...
function checkRecipientRestriction(constraint, parameters) {
...
function checkFrequencyLimit(_constraint, _parameters, context) {
...
function checkCustom(constraint, action) {
 ...
 */
function matchConsent(authorisation, action, context) {
    ...
    const status = violations.length > 0 ? 'exceeded' : 'within_bounds';
    return {
        authorisation_id: authorisation.id,
        action_id: action.id,
        status,
